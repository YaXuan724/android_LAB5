...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() { //Button點擊事件
            @Override
            public void onClick(View view) {
                final AlertDialog.Builder dialog = new AlertDialog.Builder(MainActivity.this);//建立AlertDialog物件
    ...
    private void showToast(){
        ...
        View layout = inflater.inflate(R.layout.custom_toast_root
